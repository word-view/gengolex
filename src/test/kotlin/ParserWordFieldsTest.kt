...
class ParserWordFieldsTest {
    ...
    fun japaneseWords() {
        ...
        testFindWords(parser, "私は", "i", "私", Type.NOUN, null, false, Representation.DESCRIPTION, "Me, i", null)
        testFindWords(parser, "雨が降る", "rain", "雨", Type.NOUN, null, true, Representation.ILLUSTRATION, null, "ame")
    }
    ...
    private fun testFindWords(
        ...
        assertEquals(expectedTime, words.single().time)
